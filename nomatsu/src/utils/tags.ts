export interface Tag {
  ...
  export const tagGroups: Record<string, TagGroup> = {
    Format: [
      ...
      { id: 'f8f62932-27da-4fe4-8ee1-6779a8c5edba', name: 'Official Colored' },
    ...
    Genre: [
      ...
      { id: '87cc87cd-a395-47af-b27a-93258283ef6c', name: 'Adventure' },
      ...
      { id: 'b3a342a2-a437-4ddf-9afc-f46675621f9f', name: 'Sci-Fi' },
      { id: 'e5301a23-ebd9-49dd-a0cb-2add944c7fe9', name: 'Slice of Life' },
      { id: 'ac72833b-c4e9-4878-b9db-6c8a4a99444a', name: 'Sports' },
    ...
    Theme: [
      ...
      { id: 'b29d6a3d-1569-4e7a-8caf-7557bc92cd5d', name: 'Gender Swap' },
      { id: 'aea9d498-be20-43e7-9454-edf97ced6dae', name: 'Ghosts' },
      ...
      { id: '5fff9cde-849c-4d78-aab8-905d99d50ce6', name: 'Survival' },
      { id: '292e862b-2d17-4062-90a2-0356caa4ae27', name: 'Time Travel' },
      { id: 'f8bf67ea-a878-4051-abd5-0b074adbdcd5', name: 'Traditional Games' },
    ...
    Content: [
      ...
      { id: 'f8bf67ea-a878-4051-abd5-0b074adbdcd5', name: 'Strong Language' },
      { id: 'b14b4d9f-4f70-4e3d-a5c3-9952e91da940', name: 'Pornographic' },
    ],
  };